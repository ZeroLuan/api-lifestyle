# 🚀 Backend Technical Challenge - Bootcamp 2026-1

Este projeto é uma API REST robusta desenvolvida para o desafio técnico do Bootcamp 2026-1. A aplicação gerencia atividades esportivas, check-ins, sistema de experiência (XP) e conquistas de usuários.
